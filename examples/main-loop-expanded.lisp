;; Main loop and SDL
;; =================
;; Lispbuilder-sdl provides some great tools for managing 
...
;;      main game loop. It processes incoming SDL events and
...
;; lispbuilder-sdl's with-events did REALLY well.
