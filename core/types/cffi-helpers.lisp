...
(defun gl-type-for-lisp-data (val)
  (etypecase val
    (redefinable-gstruct (type-of val))
    (static-gstruct (type-of val))
    (boolean :bool)
    ...
    ((simple-array single-float (4)) :mat2)
    ((simple-array single-float (9)) :mat3)
    ((simple-array single-float (16)) :mat4)
    ((simple-array single-float (6)) :mat2x3)
    ((simple-array single-float (8)) :mat2x4)
    ((simple-array single-float (12)) :mat3x4)
    ((simple-array (signed-byte 32) (2)) :ivec2)
    ((simple-array (signed-byte 32) (3)) :ivec3)
    ((simple-array (signed-byte 32) (4)) :ivec4)
    ((simple-array (unsigned-byte 8) (2)) :uint8-vec2)
    ((simple-array (unsigned-byte 8) (3)) :uint8-vec3)
    ((simple-array (unsigned-byte 8) (4)) :uint8-vec4)
    ((simple-array (signed-byte 8) (2)) :int8-vec2)
    ((simple-array (signed-byte 8) (3)) :int8-vec3)
    ((simple-array (signed-byte 8) (4)) :int8-vec4)))
