...
(defun2 make-ubo (data &optional element-type)
...
(defun2 make-ubo-from-array (data &optional (index 0) element-type)
  (assert (>= index 0))
...
(defun2 make-ubo-from-buffer (&rest not-yet-implemented)
