...
(defun2 c-populate (c-array data &optional (check-sizes t))
...
(defun2 rm-index-to-coords (index subscripts)
  (let ((cur index))
    (nreverse
...
(defun2 validate-dimensions (data dimensions)
...
(defun2 validate-arr-dimensions (data dimensions)
...
(defun2 validate-seq-dimensions (data dimensions &optional (orig-dim dimensions) accum)
  (if (null dimensions)
      (reverse accum)
      (typecase data
        (sequence
