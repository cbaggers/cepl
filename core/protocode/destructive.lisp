...
(defun map-c (function c-array)
  (let ((result (make-c-array nil :dimensions (c-array-rank c-array)
    ...
    (case= (c-array-rank c-array)
      (1 (%map-into-c-1d result function c-array))
      (2 (%map-into-c-2d result function c-array))
      (3 (%map-into-c-3d result function c-array))
      (otherwise (%map-into-c-nd result function c-array)))))

(defun map-into-c (destination-c-array function source-c-array)
  (case= (c-array-rank c-array)
    (1 (%map-into-c-1d destination-c-array function source-c-array))
    (2 (%map-into-c-2d destination-c-array function source-c-array))
    (3 (%map-into-c-3d destination-c-array function source-c-array))
